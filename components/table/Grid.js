    ...
    <div className="border border-gray-100 dark:border-gray-600 overflow-hidden flex justify-center box">
      {events.map((evt, idx) => (
        <div
          ...
          className={`${
            evt.label
          } shadow-sm absolute flex flex-col justify-center rounded-md  z-10 cursor-pointer hover:scale-x-105 hover:shadow-md bg-opacity-80 dark:bg-opacity-100 transition ${
            evt.duration == 0
